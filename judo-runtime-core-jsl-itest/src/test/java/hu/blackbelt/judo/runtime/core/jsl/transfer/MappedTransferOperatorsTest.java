...
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.defaultoperators.DefaultOperators;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.defaultoperators.DefaultOperatorsIdentifier;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.derivedoperators.DerivedOperators;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.derivedoperators.DerivedOperatorsIdentifier;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.transferdefaultoperators.TransferDefaultOperators;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.transferdefaultoperators.TransferDefaultOperatorsDao;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.transferderivedoperators.TransferDerivedOperators;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.transferderivedoperators.TransferDerivedOperatorsDao;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.transferderivedsource.TransferDerivedSource;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.defaultoperators.DefaultOperatorsDao;
import hu.blackbelt.judo.psm.generator.sdk.core.test.api.mappedtransferoperators.mappedtransferoperators.derivedoperators.DerivedOperatorsDao;
import hu.blackbelt.judo.psm.generator.sdk.core.test.guice.MappedTransferOperatorsDaoModules;
...
public class MappedTransferOperatorsTest extends AbstractJslTest {
    ...
    public Module getModelDaoModule() {
        return new MappedTransferOperatorsDaoModules();
    }

    @Override
    public String getModelName() {
        return "MappedTransferOperators";
    }
     ...
     *
     * @jslModel MappedTransferOperationsTest.jsl
     *
