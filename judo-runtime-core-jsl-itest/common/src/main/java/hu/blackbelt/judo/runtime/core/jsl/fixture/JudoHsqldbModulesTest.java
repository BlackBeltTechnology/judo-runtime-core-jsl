...
public class JudoHsqldbModulesTest extends JudoModule {
    ...
    @Builder
    private JudoHsqldbModulesTest(Boolean runServer, String databaseName, File databasePath, Integer port) {
