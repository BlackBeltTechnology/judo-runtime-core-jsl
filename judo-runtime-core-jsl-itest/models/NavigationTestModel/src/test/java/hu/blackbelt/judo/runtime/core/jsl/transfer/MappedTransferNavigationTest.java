...
class MappedTransferNavigationTest {
    ...
    public void testNavigationTransferPersonWithParentsOnTransfer() {
        ...
        List<TransferPerson> people = transferPersonDao.findAllById(List.of(person1.identifier().getIdentifierAs(UUID.class), person2.identifier().getIdentifier(), person3.identifier().getIdentifier()));
